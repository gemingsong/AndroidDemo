...
import com.hmct.abstract_factory_mode.client.AbstractFactoryModeClient;
...
//        testFactoryMethodPattern();
        ...
        //测试抽象工厂模式
        testAbstractFactoryMethodPattern();

    }

    private void testAbstractFactoryMethodPattern() {
        AbstractFactoryModeClient abstractFactoryModeClient = new AbstractFactoryModeClient();
        abstractFactoryModeClient.testAbstractFactoryMode();
    }
